    ...
    <footer className="bg-background border-t border-border mt-16">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-foreground font-semibold text-lg">Turbo Alan</span>
            </div>
            <p className="text-muted-foreground text-sm">
              Advanced AI text refinement platform for reducing detection flags and improving content quality.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/developers/api" className="text-muted-foreground hover:text-primary transition-colors">
                  API
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">© 2024 Turbo Alan Refiner. All rights reserved.</p>
